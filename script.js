//todo ハートボタンを押したら数字にも色がつくようにする
//todo ハートボタンを押したら数字が+1されるようにする
...
window.addEventListener('scroll', function(){
  ...
  for(let g_element of g_elements){
    ...
    // 塗りつぶされたハートがあれば
      ...
      let good_element = g_element.parentNode.parentNode.parentNode.parentNode.parentNode
      let num_element = g_element.parentNode.parentNode.nextElementSibling.firstElementChild.firstElementChild.firstElementChild.innerHTML
      console.log(num_element)
      let heart_element = document.createElement('span');
      ...
      good_element.replaceWith(heart_element);
    }
  };
});
